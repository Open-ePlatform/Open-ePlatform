...
Ext.define('OpenEMap.action.DeleteAllFeatures', {
    ...
    constructor : function(config){
        ...
        config.tooltip = config.tooltip || 'Rensa kartan från ritade objekt.';
...
Ext.define('OpenEMap.action.DeleteMeasure', {
    ...
    constructor : function(config){
        ...
        config.tooltip = config.tooltip || 'Ta bort mätning(ar).';
...
Ext.define('OpenEMap.action.DrawObject', {
    ...
    constructor: function(config) {
        ...
        config.tooltip = config.tooltip || 'Rita fördefinierad form.';
        config.toggleGroup = 'extraTools';
...
Ext.define('OpenEMap.action.MeasureArea', {
    ...
    constructor: function(config) {
        ...
        config.tooltip = config.tooltip || 'Mät area';
        config.toggleGroup = 'extraTools';
...
Ext.define('OpenEMap.action.MeasureLine', {
    ...
    constructor: function(config) {
        ...
        config.tooltip = config.tooltip || 'Mät sträcka';
        config.toggleGroup = 'extraTools';
...
Ext.define('OpenEMap.action.ModifyGeometry', {
    ...
    constructor: function(config) {
        ...
        config.tooltip = config.tooltip || 'ändra ritat objekt';
        config.toggleGroup = 'extraTools';
...
Ext.define('OpenEMap.action.ModifyText', {
    ...
    constructor: function(config) {
        ...
        config.tooltip = config.tooltip || 'ändra text';
        config.toggleGroup = 'extraTools';
...
Ext.define('OpenEMap.action.SelectGeometry', {
    ...
    constructor: function(config) {
        ...
        config.iconCls = config.iconCls || 'action-selectgeometry';
        config.tooltip = config.tooltip || 'Välj ritat objekt';
        config.toggleGroup = 'extraTools';
...
Ext.define('OpenEMap.action.Altitude', {
    ...
    constructor: function(config) {
      ...
      var Click = OpenLayers.Class(OpenLayers.Control, {
          ...
          onClick: function(evt) {
			  ...
			  getHeightFromLM(x,y, function(height) {
    ...
    function getHeightFromLM(x, y, callback) {
      ...
      xhttp.onreadystatechange = function() {
		...
		if (xhttp.status == 200) {
		  ...
		  //alert(obj.geometry.coordinates[2]);
      ...
      xhttp.open("GET", configPath + "/3006/" + x + "/" + y + "?lmuser=sundsvall" , true);
      xhttp.send();
