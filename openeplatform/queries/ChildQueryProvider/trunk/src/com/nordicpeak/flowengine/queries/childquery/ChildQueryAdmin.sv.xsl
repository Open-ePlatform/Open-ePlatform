...
Frågetypen kan även hämta in uppgifter om övriga vårdnadshavare för barnet.
	...
	<xsl:variable name="i18n.exportChildAddressUUID">Barnets adress objektidentitet</xsl:variable>
	...
	<xsl:variable name="i18n.exportOtherGuardianAddressUUID">Andra vårdnadshavarens adress objektidentitet</xsl:variable>
	...
	<xsl:variable name="i18n.Query.setMultipartsAsOwnersSameAddress.warning">Den andra vårdnadshavaren kan bara bli medsökande om denne signerar ärendet. Om vårdnadshavarna är folkbokförda på samma adress behöver den andra vårdnadshavaren inte signera och kan då inte heller bli medsökande i ärendet.</xsl:variable>
	...
	<xsl:variable name="i18n.CalculateMode.Title">Beräkning av ålder</xsl:variable>
	<xsl:variable name="i18n.CalculateMode.Description">Välj på vilket sätt som åldern skall beräknas</xsl:variable>
	<xsl:variable name="i18n.CalculateMode.BY_YEAR">Baserat på födelseår</xsl:variable>
	<xsl:variable name="i18n.CalculateMode.BY_DATE">Baserat på födelsedatum</xsl:variable>
