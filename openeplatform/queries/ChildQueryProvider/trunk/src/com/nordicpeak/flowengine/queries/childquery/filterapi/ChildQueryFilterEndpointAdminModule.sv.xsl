...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="i18n.ChildCitizenIdentifiersTag">Barnens personnummer, efter lokal åldersfiltrering, (kommaseparerad lista)</xsl:variable>
	<xsl:variable name="i18n.UnfilteredChildCitizenIdentifiersTag">Alla barnens personnummer, före lokal åldersfiltrering, (kommaseparerad lista)</xsl:variable>
	
	<xsl:variable name="i18n.Tags">Etiketter</xsl:variable>
	<xsl:variable name="i18n.NoTagsFound">Inga etiketter hittades</xsl:variable>
	
	<xsl:variable name="i18n.ApiSourceAccount">API-konto</xsl:variable>
	<xsl:variable name="i18n.ChooseAccount">Välj konto</xsl:variable>
</xsl:stylesheet>
