...
import com.nordicpeak.flowengine.interfaces.LockableQueryInstance;
...
@XMLElement
public class ChildQueryInstance extends BaseQueryInstance implements StringValueQueryInstance, MultiSignQueryinstance, FixedAlternativesQueryInstance, ColumnExportableQueryInstance, CitizenIdentifierQueryInstance, LockableQueryInstance {
	...
	public void setAttributes(MutableAttributeHandler attributeHandler) {
		...
		if (query.isSetAsAttribute() && query.getAttributeName() != null) {
			...
			attributeHandler.setAttribute(query.getAttributeName() + ".childAddressObjectIdentity", addressUUID);
		...
		if (query.isSetSecondGuardianAsAttribute() && query.getSecondGuardianAttributeName() != null && storedGuardians != null) {
			...
			for (StoredGuardian storedGuardian : storedGuardians) {
				if (!storedGuardian.isPoster()) {
					...
					attributeHandler.setAttribute(query.getSecondGuardianAttributeName() + ".guardianAddressObjectIdentity", storedGuardian.getAddressUUID());					
	...
	public void reset(MutableAttributeHandler attributeHandler) {
		...
		if (query.isSetAsAttribute() && query.getAttributeName() != null) {
			...
			if(query.isShowAddress()) {
				...
				attributeHandler.removeAttribute(query.getAttributeName() + ".childAddress");
				attributeHandler.removeAttribute(query.getAttributeName() + ".childZipcode");
				attributeHandler.removeAttribute(query.getAttributeName() + ".childPostalAddress");
			}
