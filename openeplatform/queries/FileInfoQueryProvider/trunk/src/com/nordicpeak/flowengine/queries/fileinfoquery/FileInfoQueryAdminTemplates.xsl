			...
			<div class="full">
					...
					<div class="upload clearboth">
						<span class="btn btn-upload btn-blue">
							...
							<input id="fileuploader" type="file" name="fileuploader_newfile" multiple="multiple" aria-label="{$i18n.ChooseFiles}" aria-describedby="uploadFileInfo" size="55" class="fileuploader bigmarginbottom hidden"/>
						</span>
