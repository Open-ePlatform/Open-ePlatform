	...
	<xsl:template match="ShowQueryValues">
		...
		<div class="query" id="{$queryID}">
			<xsl:attribute name="class">
				...
				<xsl:if test="MultiGeometryMapQueryInstance/QueryInstanceDescriptor/QueryDescriptor/mergeWithPreviousQuery = 'true'"> mergewithpreviousquery</xsl:if>
			</xsl:attribute>
			...
			<article>
				...
				<div class="heading-wrapper">
					...
					<xsl:call-template name="createUpdateButton">
						...
						<xsl:with-param name="queryName" select="MultiGeometryMapQueryInstance/QueryInstanceDescriptor/QueryDescriptor/name" />
					</xsl:call-template>
				</div>
