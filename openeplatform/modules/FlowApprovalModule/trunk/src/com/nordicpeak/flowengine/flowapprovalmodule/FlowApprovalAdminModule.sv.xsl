...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="i18n.Activity.onlyUseGlobalNotifiationsInfo">OBS Gruppens aktivitetstaggar kommer lista alla aktiviteter oavsett om personen är behörig till dem eller ej</xsl:variable>
	...
	<xsl:variable name="i18n.TagsTable.Description.Email">Följande taggar kan användas i rubrik och meddelande (alla taggar nämns ej här)</xsl:variable>
	...
	<xsl:variable name="i18n.Tag.Manager.firstname">Aktivitetsansvarigs förnamn</xsl:variable>
	<xsl:variable name="i18n.Tag.Attributes">Värde på attribut från ärende</xsl:variable>
