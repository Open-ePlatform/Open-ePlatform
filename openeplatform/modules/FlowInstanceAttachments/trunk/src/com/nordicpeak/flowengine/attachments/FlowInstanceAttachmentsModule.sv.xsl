...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="java.newAttachmentsManagerEmailSubject">Nya handlingar kopplat till ärendet $flow.name (ärende nr. $flowInstance.flowInstanceID)</xsl:variable>
	<xsl:variable name="java.newAttachmentsManagerEmailMessage">
	...
	<xsl:variable name="i18n.Description">Nedan ser du handlingar som handläggaren lagt till på ärendet.</xsl:variable>
	<xsl:variable name="i18n.Description.AllowUserUpload">Nedan ser du handlingar som lagts till på ärendet.</xsl:variable>

	<xsl:variable name="i18n.adminExtensionViewTitle">Inställningar för handlingar av e-tjänst</xsl:variable>
	<xsl:variable name="i18n.Settings.NotificationTitle">Notifieringar</xsl:variable>
	<xsl:variable name="i18n.Settings.Active">Visa Handlingar</xsl:variable>
	<xsl:variable name="i18n.Settings.Active.description">Aktivera tillägget handlingar</xsl:variable>
	<xsl:variable name="i18n.Settings.AllowUserUpload">Tillåt sökande att ladda upp handlingar</xsl:variable>
	
	<xsl:variable name="i18n.Settings.sendEmail">Skicka e-postnotifiering till sökande när handläggaren lagt till nya handlingar</xsl:variable>
	<xsl:variable name="i18n.Settings.sendSms">Skicka smsnotifiering till sökande när handläggaren lagt till nya handlingar</xsl:variable>
	<xsl:variable name="i18n.Settings.sendManagerEmail">Skicka e-postnotifiering till handläggare när nya handlingar lagts till</xsl:variable>
