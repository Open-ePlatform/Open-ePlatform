...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="java.flowInstanceMultiSignCanceledOwnerEmailSubject">Signering av ärende $flow.name (ärende nr. $flowInstance.flowInstanceID) avbruten</xsl:variable>
	<xsl:variable name="java.flowInstanceMultiSignCanceledOwnerEmailMessage">
	
		&lt;p&gt;Hej $contact.firstname,&lt;/p&gt;
		
		&lt;p&gt;$signingParty.firstname $signingParty.lastname har valt att avbryta signeringen av ärende $flow.name (ärende nr. $flowInstance.flowInstanceID).&lt;/p&gt;
	...
	<xsl:variable name="java.sendFlowInstanceCompletionManagerGroupEmailSubject">En komplettering av ärendet $flow.name (ärende nr. $flowInstance.flowInstanceID) har skickats in</xsl:variable>
	<xsl:variable name="java.sendFlowInstanceCompletionManagerGroupEmailMessage">
	...
	<xsl:variable name="java.flowInstanceArchivedEmailSubject">Handläggningen av ärendet $flow.name (ärende nr. $flowInstance.flowInstanceID) har slutförts.</xsl:variable>
	<xsl:variable name="java.flowInstanceArchivedEmailMessage">
	...
	<xsl:variable name="i18n.FlowInstanceIDTag">Ärendenummer</xsl:variable>
	...
	<xsl:variable name="i18n.FLowInstanceAttachedPDFTextTag">Text som beskriver att PDF-ansökan finns bifogad i meddelandet, eller att den tagits bort p.g.a. storleksbegränsning</xsl:variable>
	...
	<xsl:variable name="i18n.FlowInstanceArchivedGlobalEmailAttachPDFAttachmentsSeperately">Bifoga bilagor separat</xsl:variable>
	...
	<xsl:variable name="i18n.FlowInstanceExternalMessageReceivedGlobalEmailSubject">Rubrik på e-postmeddelande till myndighetsbrevlåda vid nytt meddelande</xsl:variable>
	<xsl:variable name="i18n.FlowInstanceExternalMessageReceivedGlobalEmailMessage">Innehåll på e-postmeddelande till myndighetsbrevlåda vid nytt meddelande</xsl:variable>
	...
	<xsl:variable name="i18n.SendFlowInstanceCompletionManagerGroupEmail">E-post till tilldelade handläggargrupper vid inskickad komplettering</xsl:variable>
	<xsl:variable name="i18n.SendFlowInstanceCompletionManagerGroupEmailSubject">Rubrik på e-postmeddelande vid inskickad komplettering</xsl:variable>
	<xsl:variable name="i18n.SendFlowInstanceCompletionManagerGroupEmailMessage">Innehåll i e-postmeddelande vid inskickad komplettering</xsl:variable>
	...
	<xsl:variable name="i18n.SendArchivedFlowInstanceManagerEmail">E-post till tilldelade handläggare vid avslutat ärende</xsl:variable>
	<xsl:variable name="i18n.FlowInstanceArchivedEmailSubject">Rubrik på e-postmeddelande vid avslutat ärende</xsl:variable>
	<xsl:variable name="i18n.FlowInstanceArchivedEmailMessage">Innehåll i e-postmeddelande vid avslutat ärende</xsl:variable>
