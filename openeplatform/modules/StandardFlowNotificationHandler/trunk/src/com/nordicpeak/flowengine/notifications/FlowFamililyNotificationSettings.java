...
public class FlowFamililyNotificationSettings extends GeneratedElementable {
	...
	public Element toXML(Document doc) {
		...
		if (sendExternalMessageReceivedManagerEmail || sendFlowInstanceAssignedManagerEmail || sendStatusChangedManagerEmail || sendFlowInstanceSubmittedManagerEmail || sendInternalMessageAddedManagerEmail || sendFlowInstanceCompletionManagerEmail || sendFlowInstanceExpiredManagerEmail || sendArchivedFlowInstanceManagerEmail) {
	...
	public String getExternalMessageReceivedGlobalEmailSubject() {

		return externalMessageReceivedGlobalEmailSubject;
	}

	public void setExternalMessageReceivedGlobalEmailSubject(String externalMessageReceivedGlobalEmailSubject) {

		this.externalMessageReceivedGlobalEmailSubject = externalMessageReceivedGlobalEmailSubject;
	}

	public String getExternalMessageReceivedGlobalEmailMessage() {

		return externalMessageReceivedGlobalEmailMessage;
	}

	public void setExternalMessageReceivedGlobalEmailMessage(String externalMessageReceivedGlobalEmailMessage) {

		this.externalMessageReceivedGlobalEmailMessage = externalMessageReceivedGlobalEmailMessage;
	}
	...
	public boolean isSendArchivedFlowInstanceManagerEmail() {

		return sendArchivedFlowInstanceManagerEmail;
	}

	public void setSendArchivedFlowInstanceManagerEmail(boolean sendArchivedFlowInstanceManagerEmail) {

		this.sendArchivedFlowInstanceManagerEmail = sendArchivedFlowInstanceManagerEmail;
	}

	public String getFlowInstanceArchivedEmailSubject() {

		return flowInstanceArchivedEmailSubject;
	}

	public void setFlowInstanceArchivedEmailSubject(String flowInstanceArchivedEmailSubject) {

		this.flowInstanceArchivedEmailSubject = flowInstanceArchivedEmailSubject;
	}

	public String getFlowInstanceArchivedEmailMessage() {

		return flowInstanceArchivedEmailMessage;
	}

	public void setFlowInstanceArchivedEmailMessage(String flowInstanceArchivedEmailMessage) {

		this.flowInstanceArchivedEmailMessage = flowInstanceArchivedEmailMessage;
	}
	...
	public boolean isSendFlowInstanceCompletionManagerGroupEmail() {

		return sendFlowInstanceCompletionManagerGroupEmail;
	}

	public void setSendFlowInstanceCompletionManagerGroupEmail(boolean sendFlowInstanceCompletionManagerGroupEmail) {

		this.sendFlowInstanceCompletionManagerGroupEmail = sendFlowInstanceCompletionManagerGroupEmail;
	}

	public String getSendFlowInstanceCompletionManagerGroupEmailSubject() {

		return sendFlowInstanceCompletionManagerGroupEmailSubject;
	}

	public void setSendFlowInstanceCompletionManagerGroupEmailSubject(String sendFlowInstanceCompletionManagerGroupEmailSubject) {

		this.sendFlowInstanceCompletionManagerGroupEmailSubject = sendFlowInstanceCompletionManagerGroupEmailSubject;
	}

	public String getSendFlowInstanceCompletionManagerGroupEmailMessage() {

		return sendFlowInstanceCompletionManagerGroupEmailMessage;
	}

	public void setSendFlowInstanceCompletionManagerGroupEmailMessage(String sendFlowInstanceCompletionManagerGroupEmailMessage) {

		this.sendFlowInstanceCompletionManagerGroupEmailMessage = sendFlowInstanceCompletionManagerGroupEmailMessage;
	}
