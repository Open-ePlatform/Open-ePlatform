...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="ShowSettings">
		...
		<xsl:if test="NotificationSettings/HasEnabledManagerNotifications">
			...
			<ul class="nomargin">
				...
				<xsl:if test="NotificationSettings/sendArchivedFlowInstanceManagerEmail = 'true'">
					<li>
						<xsl:value-of select="$i18n.SendArchivedFlowInstanceManagerEmail"/>
					</li>
				</xsl:if>
		...
		<xsl:if test="NotificationSettings/HasEnabledGroupNotifications">
			...
			<ul class="nomargin">
				...
				<xsl:if test="NotificationSettings/sendFlowInstanceCompletionManagerGroupEmail = 'true'">
					<li>
						<xsl:value-of select="$i18n.SendFlowInstanceCompletionManagerGroupEmail"/>
					</li>
				</xsl:if>
	...
	<xsl:template match="UpdateSettings">
		...
		<script>
			...
			function toggleManagerArchivedMessage() {
				$("#manager-archived-subject, #manager-archived-message").toggleClass("hidden d-flex flex-column");
			}
			...
			function toggleManagerGroupFlowInstanceCompletionMessage() {
				
				$("#managergroup-flowinstance-completion-subject, #managergroup-flowinstance-completion-message").toggleClass("hidden");
			}
			...
			function toogleGlobalReceived() {
			
				$("#global-external-message-received-subject, #global-external-message-received-message").toggleClass("hidden");
			}
		...
		<div class="d-flex full bigmarginbottom margintop internal">
		
			<div class="d-flex align-items-center" style="margin-top: 15px;">
				<xsl:call-template name="createCheckbox">
					<xsl:with-param name="name" select="'sendArchivedFlowInstanceManagerEmail'" />
					<xsl:with-param name="id" select="'sendArchivedFlowInstanceManagerEmail'" />
					<xsl:with-param name="element" select="NotificationSettings" />
				</xsl:call-template>
				
				<label for="sendArchivedFlowInstanceManagerEmail" class="nomargin">
					<xsl:value-of select="$i18n.SendArchivedFlowInstanceManagerEmail" />
				</label>
				<xsl:text>&#160;</xsl:text>
				<span class="tiny"><a onclick="toggleManagerArchivedMessage();"><xsl:value-of select="$i18n.ToggleTexts" /></a></span>
			</div>
		</div>
		
		<div class="d-flex flex-column full bigmarginbottom" id="manager-archived-subject">
		
			<xsl:if test="not($errFieldNames = 'flowInstanceArchivedEmailSubject') and not($errFieldNames = 'flowInstanceArchivedEmailMessage')">
				<xsl:attribute name="class">full bigmarginbottom hidden</xsl:attribute>
			</xsl:if>
		
			<label for="flowInstanceArchivedEmailSubject" class="full nomargin">
				<xsl:value-of select="$i18n.FlowInstanceArchivedEmailSubject" />
			</label>
			
			<div class="full">
				<xsl:call-template name="createTextField">
					<xsl:with-param name="id" select="'flowInstanceArchivedEmailSubject'"/>
					<xsl:with-param name="name" select="'flowInstanceArchivedEmailSubject'"/>
					<xsl:with-param name="element" select="NotificationSettings" />
				</xsl:call-template>
			</div>
		</div>
		
		<div class="d-flex flex-column full bigmarginbottom" id="manager-archived-message">
			
			<xsl:if test="not($errFieldNames = 'flowInstanceArchivedEmailSubject') and not($errFieldNames = 'flowInstanceArchivedEmailMessage')">
				<xsl:attribute name="class">full bigmarginbottom hidden</xsl:attribute>
			</xsl:if>
			
			<label for="flowInstanceArchivedEmailMessage" class="full nomargin">
				<xsl:value-of select="$i18n.FlowInstanceArchivedEmailMessage" />
			</label>
			
			<div class="full">

				<xsl:call-template name="createTextArea">
					<xsl:with-param name="id" select="'flowInstanceArchivedEmailMessage'"/>
					<xsl:with-param name="name" select="'flowInstanceArchivedEmailMessage'"/>
					<xsl:with-param name="class" select="'flow-ckeditor'"/>
					<xsl:with-param name="element" select="NotificationSettings" />
				</xsl:call-template>
		...
		<div class="floatleft full bigmarginbottom margintop internal">
			...
			<div class="floatleft">
				<xsl:call-template name="createCheckbox">
					<xsl:with-param name="name" select="'sendFlowInstanceCompletionManagerGroupEmail'" />
					<xsl:with-param name="id" select="'sendFlowInstanceCompletionManagerGroupEmail'" />
					<xsl:with-param name="element" select="NotificationSettings" />
				</xsl:call-template>
				
				<label for="sendFlowInstanceCompletionManagerGroupEmail">
					<xsl:value-of select="$i18n.SendFlowInstanceCompletionManagerGroupEmail" />
				</label>
				<xsl:text>&#160;</xsl:text>
				<span class="tiny"><a onclick="toggleManagerGroupFlowInstanceCompletionMessage();"><xsl:value-of select="$i18n.ToggleTexts" /></a></span>
			</div>
		</div>
		
		<div class="floatleft full bigmarginbottom" id="managergroup-flowinstance-completion-subject">
		
			<xsl:if test="not($errFieldNames = 'sendFlowInstanceCompletionManagerGroupEmailSubject') and not($errFieldNames = 'sendFlowInstanceCompletionManagerGroupEmailMessage')">
				<xsl:attribute name="class">floatleft full bigmarginbottom hidden</xsl:attribute>
			</xsl:if>
		
			<label for="sendFlowInstanceCompletionManagerGroupEmailSubject" class="floatleft full">
				<xsl:value-of select="$i18n.SendFlowInstanceCompletionManagerGroupEmailSubject" />
			</label>
			
			<div class="floatleft full">
				<xsl:call-template name="createTextField">
					<xsl:with-param name="id" select="'sendFlowInstanceCompletionManagerGroupEmailSubject'"/>
					<xsl:with-param name="name" select="'sendFlowInstanceCompletionManagerGroupEmailSubject'"/>
					<xsl:with-param name="element" select="NotificationSettings" />
				</xsl:call-template>
			</div>
		</div>
		
		<div class="floatleft full bigmarginbottom" id="managergroup-flowinstance-completion-message">
			
			<xsl:if test="not($errFieldNames = 'sendFlowInstanceCompletionManagerGroupEmailSubject') and not($errFieldNames = 'sendFlowInstanceCompletionManagerGroupEmailMessage')">
				<xsl:attribute name="class">floatleft full bigmarginbottom hidden</xsl:attribute>
			</xsl:if>
			
			<label for="sendFlowInstanceCompletionManagerGroupEmailMessage" class="floatleft full">
				<xsl:value-of select="$i18n.SendFlowInstanceCompletionManagerGroupEmailMessage" />
			</label>
			
			<div class="floatleft full">

				<xsl:call-template name="createTextArea">
					<xsl:with-param name="id" select="'sendFlowInstanceCompletionManagerGroupEmailMessage'"/>
					<xsl:with-param name="name" select="'sendFlowInstanceCompletionManagerGroupEmailMessage'"/>
					<xsl:with-param name="class" select="'flow-ckeditor'"/>
					<xsl:with-param name="element" select="NotificationSettings" />
				</xsl:call-template>
		...
		<div class="floatleft full bigmarginbottom margintop internal">
			...
			<div class="floatleft">
				...
				<xsl:text>&#160;</xsl:text>
				<span class="tiny"><a onclick="toogleGlobalReceived();"><xsl:value-of select="$i18n.ToggleTexts" /></a></span>
			</div>
		</div>
		
		<div class="floatleft full bigmarginbottom" id="global-external-message-received-subject">
			
			<xsl:if test="not($errFieldNames = 'externalMessageReceivedGlobalEmailSubject') and not($errFieldNames = 'externalMessageReceivedGlobalEmailMessage')">
				<xsl:attribute name="class">floatleft full bigmarginbottom hidden</xsl:attribute>
			</xsl:if>
			
			<label for="externalMessageReceivedGlobalEmailSubject" class="floatleft full">
				<xsl:value-of select="$i18n.FlowInstanceExternalMessageReceivedGlobalEmailSubject" />
			</label>
			
			<div class="floatleft full">

				<xsl:call-template name="createTextField">
					<xsl:with-param name="id" select="'externalMessageReceivedGlobalEmailSubject'"/>
					<xsl:with-param name="name" select="'externalMessageReceivedGlobalEmailSubject'"/>
					<xsl:with-param name="element" select="NotificationSettings" />
				</xsl:call-template>
		...
		<div class="floatleft full bigmarginbottom" id="global-external-message-received-message">
			
			<xsl:if test="not($errFieldNames = 'externalMessageReceivedGlobalEmailSubject') and not($errFieldNames = 'externalMessageReceivedGlobalEmailMessage')">
				<xsl:attribute name="class">floatleft full bigmarginbottom hidden</xsl:attribute>
			</xsl:if>
			
			<label for="externalMessageReceivedGlobalEmailMessage" class="floatleft full">
				<xsl:value-of select="$i18n.FlowInstanceExternalMessageReceivedGlobalEmailMessage" />
			</label>
			
			<div class="floatleft full">

				<xsl:call-template name="createTextArea">
					<xsl:with-param name="id" select="'externalMessageReceivedGlobalEmailMessage'"/>
					<xsl:with-param name="name" select="'externalMessageReceivedGlobalEmailMessage'"/>
					<xsl:with-param name="class" select="'flow-ckeditor'"/>
					<xsl:with-param name="element" select="NotificationSettings" />
				</xsl:call-template>
		...
		<div class="floatleft full bigmarginbottom">
			...
			<div class="floatleft full">
				<xsl:call-template name="createTextArea">
					...
					<xsl:with-param name="rows" select="5"/>
					<xsl:with-param name="separateListValues" select="'true'"/>
					<xsl:with-param name="element" select="NotificationSettings/ReadReceiptAttachmentDownloadedGlobalEmailAddresses/address" />
				</xsl:call-template>
			</div>
		</div>		
		...
		<xsl:if test="fieldName and validationErrorType and not(messageKey)">
			<p class="error">
				...
				<xsl:choose>
					...
					<xsl:when test="fieldName = 'readReceiptAttachmentDownloadedGlobalEmailAddresses'">
						<xsl:value-of select="$i18n.ReadReceiptAttachmentDownloadedGlobalEmailAddresses"/>
					</xsl:when>
					<xsl:otherwise>
