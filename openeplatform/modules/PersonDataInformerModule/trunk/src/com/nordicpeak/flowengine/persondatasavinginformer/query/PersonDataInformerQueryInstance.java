...
public class PersonDataInformerQueryInstance extends BaseQueryInstance implements FixedAlternativesQueryInstance {
	...
	@SimplifiedRelation(table = "person_data_informer_query_instance_data_alternatives", remoteKeyColumnName = "queryInstanceID", remoteValueColumnName = "alternativeName")
	@XMLElement(fixCase = true, childName = "selectedDataAlternative")
	private List<String> selectedDataAlternatives;
	
	@DAOManaged
	@OneToMany(autoAdd = true, autoGet = true, autoUpdate = true)
	@SimplifiedRelation(table = "person_data_informer_query_instance_reason_alternatives", remoteKeyColumnName = "queryInstanceID", remoteValueColumnName = "alternativeName")
	@XMLElement(fixCase = true, childName = "selectedReasonAlternative")
	private List<String> selectedReasonAlternatives;
	...
	@XMLElement
	private boolean isInvalidConfiguration = false;
	...
	public List<String> getSelectedDataAlternatives() {

		return selectedDataAlternatives;
	}

	public void setSelectedDataAlternatives(List<String> dataAlternatives) {

		this.selectedDataAlternatives = dataAlternatives;
	}

	public List<String> getSelectedReasonAlternatives() {

		return selectedReasonAlternatives;
	}

	public void setSelectedReasonAlternatives(List<String> selectedReasonAlternatives) {

		this.selectedReasonAlternatives = selectedReasonAlternatives;
	}
	...
	public boolean isInvalidConfiguration() {
		...
		return isInvalidConfiguration;
	}

	public void setInvalidConfiguration(boolean isInvalidConfiguration) {

		this.isInvalidConfiguration = isInvalidConfiguration;
	}
