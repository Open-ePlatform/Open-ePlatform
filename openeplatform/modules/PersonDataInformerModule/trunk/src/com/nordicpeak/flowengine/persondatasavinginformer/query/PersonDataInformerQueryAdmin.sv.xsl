...
OBS! Frågetypen kräver att tillägget 'Personuppgiftshantering' är aktiverat på e-tjänsten. Det finns under 'tillägg och extrafunktioner' inne på e-tjänsten i e-tjänstebyggaren.
Om det inte är aktiverat kommer e-tjänsten inte att fungera om den här frågetypen finns med.
	</xsl:variable>	
