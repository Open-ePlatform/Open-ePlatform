...
public class FlowEngineFileAttachmentUtils {
	...
	public static void deleteAttachment(FileAttachmentHandler fileAttachmentHandler, BaseMessage message, BaseAttachment attachment) throws IOException {
		
		if (fileAttachmentHandler != null) {
			String[] path = getAttachmentPath(message, attachment);
			
			fileAttachmentHandler.deleteAttachment(path);
		}
	}
