...
public class BaseFlowModuleInlinePaymentCallback implements FlowPaymentCallback {
	...
	public String getPaymentFailURL(FlowInstanceManager instanceManager, HttpServletRequest req) {
		...
		return baseFlowModule.getPaymentFailURL((MutableFlowInstanceManager) instanceManager, req);
	}
	
	@Override
	public String getPaymentURL(FlowInstanceManager instanceManager, HttpServletRequest req) {

		return baseFlowModule.getSaveAndSubmitURL((MutableFlowInstanceManager) instanceManager, req);
	}
