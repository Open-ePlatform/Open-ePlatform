...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="java.defaultLoginHelpLinkName">Så här skaffar du e-legitimation (öppnas i nytt fönster)</xsl:variable>
	...
	<xsl:variable name="i18n.externalDescription">Beskrivning för inskickare</xsl:variable>
	<xsl:variable name="i18n.internalDescription">Beskrivning för handläggare</xsl:variable>
	...
	<xsl:variable name="i18n.PublishDatesInfo">E-tjänsten är publicerad från och med publiceringsdatum till och med avpubliceringsdatum</xsl:variable>
	...
	<xsl:variable name="i18n.disableUnpublishedSavedFlows">Stäng av möjligheten att skicka in sparade ärenden när versionen inte är publicerad</xsl:variable>
	...
	<xsl:variable name="i18n.UpdateManagers.Modal.hideGroupInAssignment">Dölj grupp vid tilldelning av handläggare</xsl:variable>
	...
	<xsl:variable name="i18n.Manager.hideGroupInAssignment">Dold vid handläggartilldelning</xsl:variable>
	...
	<xsl:variable name="i18n.allowDeletingInternalMessages">Tillåt handläggare att ta bort interna noteringar</xsl:variable>
	...
	<xsl:variable name="i18n.HideAsteriskInfo">Dölj information om betydelsen av asterisk (*) i e-tjänsten</xsl:variable>
	...
	<xsl:variable name="i18n.AutoManagerAssignment.Rules.Add.Info">För att spara ändringarna måste du först klicka på knappen "Lägg till" och sedan knappen "Spara ändringar" längst ner på sidan.</xsl:variable>
	<xsl:variable name="i18n.AutoManagerAssignment.Rules.Update.Info">För att spara ändringarna måste du först klicka på knappen "Ändra regel" och sedan knappen "Spara ändringar" längst ner på sidan.</xsl:variable>
	...
	<xsl:variable name="i18n.AutoManagerAssignment.Rule.Add">Lägg till</xsl:variable>
	...
	<xsl:variable name="i18n.MessageTemplate.email">E-postutskick</xsl:variable>
	...
	<xsl:variable name="i18n.Flow.hideOverviewPDF">Dölj valet 'Hämta PDF' från kvittens-sidan</xsl:variable>
	<xsl:variable name="i18n.Flow.hideOverviewFlowInstance">Dölj valet 'Visa detaljer' från kvittens-sidan</xsl:variable>
