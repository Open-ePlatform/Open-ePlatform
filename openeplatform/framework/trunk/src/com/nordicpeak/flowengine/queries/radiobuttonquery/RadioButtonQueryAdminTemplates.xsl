		...
		<form id="updateRadioButtonQueryForm" name="queryAdminForm" method="post" action="{/Document/requestinfo/uri}">
			...
			<div class="d-flex flex-column bigmarginbottom">
				...
				<xsl:call-template name="createDropdown">
					...
					<xsl:with-param name="selectedValue" select="RadioButtonQuery/formatValidator"/>
				</xsl:call-template>
			...
			<div class="clearfix bigmarginbottom">
			...
			<div class="checkbox-setting">
				...
				<label for="lockForManagerUpdate" class="nomargin">
			...
			<div class="checkbox-setting">
				<xsl:call-template name="createCheckbox">
					<xsl:with-param name="id" select="'lockForOwnerUpdate'" />
					<xsl:with-param name="name" select="'lockForOwnerUpdate'" />
					<xsl:with-param name="value" select="'true'" />
					<xsl:with-param name="element" select="RadioButtonQuery" />
				</xsl:call-template>
				
				<label for="lockForOwnerUpdate" class="nomargin">
					<xsl:value-of select="$i18n.Query.lockForOwnerUpdate" />
				</label>
			</div>
