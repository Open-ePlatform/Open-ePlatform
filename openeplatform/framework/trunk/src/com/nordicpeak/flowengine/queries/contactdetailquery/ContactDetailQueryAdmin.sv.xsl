...
Om användaren har skyddad identitet hämtas inga folkbokföringsuppgifter.
	...
	<xsl:variable name="i18n.ForceSMS">Tvinga notifiering via SMS (om mobilnummer finns angivet) oavsett om användaren valt notifiering via SMS eller inte</xsl:variable>
	...
	<xsl:variable name="i18n.RequireMobilePhoneOrPhone">Kräv antingen telefon eller mobiltelefon</xsl:variable>
	...
	<xsl:variable name="i18n.Attribute.AddressUUID">Adressens objektidentitet</xsl:variable>
