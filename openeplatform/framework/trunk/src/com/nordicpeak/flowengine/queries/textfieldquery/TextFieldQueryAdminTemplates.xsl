...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
		...
		<div class="floatleft hover border full marginbottom border-radius lightbackground">
			...
			<div class="padding floatleft twenty">
				<xsl:if test="required = 'true'">
					<b class="bigmarginright"><xsl:value-of select="$i18n.Required" /></b>
				</xsl:if>
				<xsl:if test="disabled = 'true'">
					<b class="bigmarginright"><xsl:value-of select="$i18n.IsDisabled" /></b>
					<xsl:if test="containsPrice = 'true'">
						<b class="bigmarginright"><xsl:value-of select="$i18n.Cost" /></b>
					</xsl:if>
				</xsl:if>
				<xsl:if test="searchable = 'true'">
					<b class="bigmarginright"><xsl:value-of select="$i18n.IsSearchable" /></b>
				</xsl:if>
				<xsl:if test="maskFieldContent = 'true'">
					<b class="bigmarginright"><xsl:value-of select="$i18n.Masked" /></b>
				</xsl:if>
				<xsl:if test="inactivateAutocomplete = 'true'">
					<b><xsl:value-of select="$i18n.AutocompleteInactivated" /></b>
				</xsl:if>
			</div>
			<div class="padding floatleft twenty">
	...
	<xsl:template name="showTextFieldForm">
		...
		<div class="bigmarginbottom">
			<label class="nomargin" for="label"><xsl:value-of select="$i18n.Label" /></label>
		...
		<div class="checkbox-setting">
			...
			<label class="nomargin" for="disabled">
		...
		<div class="checkbox-setting">
			...
			<label class="nomargin" for="searchable">
				<xsl:value-of select="$i18n.Searchable" />
			</label>
		</div>
		
		<div class="checkbox-setting" id="contains-price">
			<xsl:call-template name="createCheckbox">
			...
			<label class="nomargin" for="containsPrice">
				<xsl:value-of select="$i18n.ContainsPrice" />
			</label>
		</div>		
		
		<div class="bigmarginbottom" id="default-value">
			<label for="defaultValue" class="nomargin"><xsl:value-of select="$i18n.DefaultValue" /></label>
			<xsl:call-template name="createTextField">
		...
		<div id="disable-hide-fields">
			<div class="checkbox-setting">
				...
				<label class="nomargin" for="required">
			...
			<div class="checkbox-setting">
				...
				<label class="nomargin" for="maskFieldContent">
					<xsl:value-of select="$i18n.MaskFieldContent" />
				</label>
			</div>					

			<p class="tiny hidden" id="disableinactivateiutocompleteinfo"><xsl:value-of select="$i18n.DisableInactivateAutocompleteSettingInfo" /></p>

			<div class="checkbox-setting" id="inactivateAutocompleteContainer" aria-describedby="disableinactivateiutocompleteinfo">
				<xsl:call-template name="createCheckbox">
					<xsl:with-param name="id" select="'inactivateAutocomplete'" />
					<xsl:with-param name="name" select="'inactivateAutocomplete'" />
					<xsl:with-param name="value" select="'true'" />
					<xsl:with-param name="element" select="$element" />
					<xsl:with-param name="class" select="'vertical-align-middle'" />
				</xsl:call-template>
				
				<label class="nomargin" for="inactivateAutocomplete">
					<xsl:value-of select="$i18n.InactivateAutocomplete" />
				</label>
			</div>
			...
			<div class="bigmarginbottom">
				<label for="formatValidator" class="nomargin"><xsl:value-of select="$i18n.FormatValidator" /></label>
				<div>
			...
			<div class="bigmarginbottom">
				<label for="invalidFormatMessage" class="nomargin"><xsl:value-of select="$i18n.InvalidFormatMessage" /></label>
				<xsl:call-template name="createTextField">
			...
			<div class="bigmarginbottom">
				<label for="placeholderText" class="nomargin"><xsl:value-of select="$i18n.PlaceHolderText" /></label>
				<xsl:call-template name="createTextField">
			...
			<div class="bigmarginbottom">
				<label for="minContentLength" class="nomargin"><xsl:value-of select="$i18n.Field.MinLength" /></label>
				<xsl:call-template name="createTextField">
			...
			<div class="bigmarginbottom">
				<label for="maxContentLength" class="nomargin"><xsl:value-of select="$i18n.MaxLength" /></label>
				<xsl:call-template name="createTextField">
		...
		<h2 class="bigpaddingtop"><xsl:value-of select="$i18n.AdvancedSettings" /></h2>
		...
		<div class="bigmarginbottom" id="attribute-container">
			<label for="attributeName" class="nomargin"><xsl:value-of select="$i18n.attributeName" /></label>
			<xsl:call-template name="createTextField">
		...
		<div class="bigmarginbottom">
			<label for="xsdElementName" class="nomargin"><xsl:value-of select="$i18n.xsdElementName" /></label>
			<xsl:call-template name="createTextField">
	...
	<xsl:template match="SelectTextFieldQueryEndpoint">
		...
		<form id="selectTextFieldQueryEndpointForm" name="selectTextFieldQueryEndpointForm" method="post" action="{/Document/requestinfo/uri}">
			...
			<div class="full floatleft hugemarginright">
				<div>
				...
				<div>
					<xsl:call-template name="createDropdown">
						...
						<xsl:with-param name="class" select="'full marginright'" />
