...
public class TextAreaQueryProviderModule extends BaseQueryProviderModule<TextAreaQueryInstance> implements BaseQueryCRUDCallback {
	...
	public void populate(TextAreaQueryInstance queryInstance, HttpServletRequest req, User user, User poster, boolean allowPartialPopulation, MutableAttributeHandler attributeHandler, InstanceRequestMetadata requestMetadata) throws ValidationException {
		...
		if (queryInstance.getQuery().getFormatValidator() != null) {
			...
			if (formatValidator == null) {
				...
				throw new ValidationException(new InvalidFormatValidationError("q" + queryInstance.getQuery().getQueryID() + "_value", queryInstance.getQuery().getInvalidFormatMessage()));
			}
		}
	...
	private StringFormatValidator getStringFormatValidator(TextAreaQuery query) {
