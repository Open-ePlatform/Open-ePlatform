...
public class CheckboxQueryProviderModule extends BaseQueryProviderModule<CheckboxQueryInstance> implements BaseQueryCRUDCallback {
	...
	private void validateFreeTextValue(String freeTextAlternativeValue, CheckboxQueryInstance queryInstance, List<ValidationError> validationErrors) {
	...
	private StringFormatValidator getStringFormatValidator(CheckboxQuery query) {
