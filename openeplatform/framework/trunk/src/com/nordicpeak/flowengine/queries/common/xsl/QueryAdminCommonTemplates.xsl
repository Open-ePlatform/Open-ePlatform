					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<xsl:apply-templates select="exsl:node-set($helper)/AlternativeModalExtra"/>
							 ...
							 <div>
							  <p class="bold floatleft full">
							  	<xsl:value-of select="$i18n.AlternativeExtraInfo" />
							  </p>
							  </div>
							</div>

							<input class="close bigmargintop floatright" type="button" value="{$i18n.CloseAlternativeExtraSettings}" />
