...
public class TextFieldQueryEndpoint extends GeneratedElementable implements Serializable, APISource {
	...
	@WebPopulate
	@XMLElement
	private boolean resetQueryOnAPIException;
	...
	public boolean isResetQueryOnAPIException() {
		
		return resetQueryOnAPIException;
	}
	
	public void setResetQueryOnAPIException(boolean resetQueryOnAPIException) {
	
		this.resetQueryOnAPIException = resetQueryOnAPIException;
	}
