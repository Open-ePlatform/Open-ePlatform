	...
	<xsl:template match="UpdateContactDetailQuery">
		...
		<form id="updateContactDetailQueryForm" name="queryAdminForm" method="post" action="{/Document/requestinfo/uri}">
			...
			<div class="checkbox-setting">
				...
				<label for="managerUpdateAccess" class="nomargin">
					<xsl:value-of select="$i18n.ManagerUpdateAccess" />
				</label>
			</div>
			
			<label><xsl:value-of select="$i18n.Fields" /></label>
			...
			<div class="bigmarginbottom">
				<label for="fieldCitizenID" class="nomargin">
			...
			<div class="bigmarginbottom">
				<label for="fieldName" class="nomargin">
					<span class="contact-field-label">
			...
			<div class="bigmarginbottom">
				<label for="fieldCareOf" class="nomargin">
					<span class="contact-field-label">
			...
			<div class="checkbox-setting">
				...
				<label for="requireAtLeastOneContactWay" class="nomargin"><xsl:value-of select="$i18n.RequireAtLeastOneContactWay" /></label>
			</div>
			
			<div class="checkbox-setting">
				<xsl:call-template name="createCheckbox">
					<xsl:with-param name="id" select="'requireMobilePhoneOrPhone'" />
					<xsl:with-param name="name" select="'requireMobilePhoneOrPhone'" />
					<xsl:with-param name="value" select="'true'" />
					<xsl:with-param name="element" select="ContactDetailQuery" />
				</xsl:call-template>
				<label for="requireMobilePhoneOrPhone" class="nomargin"><xsl:value-of select="$i18n.RequireMobilePhoneOrPhone" /></label>
			</div>
			
			<div class="checkbox-setting">

				<xsl:call-template name="createCheckbox">
					<xsl:with-param name="id" select="'requireContactDetailInfoVerification'" />
					<xsl:with-param name="name" select="'requireContactDetailInfoVerification'" />
					<xsl:with-param name="element" select="ContactDetailQuery" />
				</xsl:call-template>
				
				<label for="requireContactDetailInfoVerification" class="nomargin">
			...
			<div class="checkbox-setting">
				...
				<label for="useOfficalAddress" class="nomargin"><xsl:value-of select="$i18n.OfficalAddress" /></label>
			</div>
			

			<h2 class="bigmargintop bigmarginbottom"><xsl:value-of select="$i18n.AdvancedSettings" /></h2>
			...
			<div id="attribute-container">
				...
				<p><xsl:value-of select="$i18n.attributeDescription" /></p>
				<div class="bigmarginbottom">
				...
				<table class="border">
					...
					<tbody>
						...
						<tr class="officialAddressMissingAttribute hidden">
							<td>prefix.addressUUID</td>
							<td><xsl:value-of select="$i18n.Attribute.AddressUUID" /></td>
						</tr>
						<tr>
