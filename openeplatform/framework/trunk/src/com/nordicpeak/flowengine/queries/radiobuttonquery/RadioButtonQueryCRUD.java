...
public class RadioButtonQueryCRUD extends BaseQueryCRUD<RadioButtonQuery, RadioButtonQueryProviderModule> {
	...
	@Override
	protected void appendUpdateFormData(RadioButtonQuery bean, Document doc, Element updateTypeElement, User user, HttpServletRequest req, URIParser uriParser) throws Exception {
