...
<p>Här hittar du ärenden som inte tilldelats någon handläggare.</p>
	...
	<xsl:variable name="i18n.Search.ManagersNotFound">Inga handläggare hittades</xsl:variable>
	<xsl:variable name="i18n.Search.loadingManagersText">Hämtar handläggare...</xsl:variable>
	<xsl:variable name="i18n.Search.ManagerSeachInfo">Det finns för många behöriga handläggare för att lista dem. Använd fältet ovan för att söka handläggare.</xsl:variable>
	...
	<xsl:variable name="i18n.ReadByAllPartsDetails">Läst av alla</xsl:variable>
