...
public class FlowFamilyManagerGroup extends GeneratedElementable implements Serializable {
	...
	@DAOManaged
	@XMLElement
	private boolean hideGroupInAssignment;
	...
	public boolean isHideGroupInAssignment() {

		return hideGroupInAssignment;
	}

	public void setHideGroupInAssignment(boolean hideGroupInAssignment) {

		this.hideGroupInAssignment = hideGroupInAssignment;
	}
	...
	public String toString() {
		...
		if (group != null) {
			...
			return group + " (restricted=" + restricted + ", allowUpdatingManagers=" + allowUpdatingManagers + ", hideGroupInAssignment=" + hideGroupInAssignment  + ", notifyGroupMembersPersonally=" + notifyGroupMembersPersonally + ")";

		} else {

			return "groupID " + groupID + " (restricted=" + restricted + ", allowUpdatingManagers=" + allowUpdatingManagers + ", hideGroupInAssignment=" + hideGroupInAssignment + ", notifyGroupMembersPersonally=" + notifyGroupMembersPersonally + ")";
		}
	}
