...
public class FlowInstance extends GeneratedElementable implements ImmutableFlowInstance, AttributeSource {
	...
	@DAOManaged
	@XMLElement
	private Timestamp lastEventAdded;
	...
	public Timestamp getLastEventAdded() {
	
		return lastEventAdded;
	}

	
	public void setLastEventAdded(Timestamp lastEventAdded) {
	
		this.lastEventAdded = lastEventAdded;
	}
