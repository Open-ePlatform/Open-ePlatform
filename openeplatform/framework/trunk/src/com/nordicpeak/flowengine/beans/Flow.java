...
public class Flow extends GeneratedElementable implements ImmutableFlow, XMLParserPopulateable, Named, Icon {
	...
	@WebPopulate
	@XMLElement
	private boolean hideAsteriskInfo;
	...
	@WebPopulate
	@XMLElement
	private boolean allowDeletingInternalMessages;
	...
	@WebPopulate
	@XMLElement
	private boolean hideOverviewPDF;
	
	@DAOManaged
	@WebPopulate
	@XMLElement
	private boolean hideOverviewFlowInstance;
	...
	public Element toXMLWithFlowAdmin(Document doc, SiteProfile siteProfile, String absoluteFileURL, HttpServletRequest req, FlowAdminModule flowAdminModule) {
		
		return toXML(doc, siteProfile, absoluteFileURL, req, flowAdminModule);
	}
	
	public Element toXML(Document doc, SiteProfile siteProfile, String absoluteFileURL, HttpServletRequest req) {

		return toXML(doc, siteProfile, absoluteFileURL, req, null);
	}
	
	private Element toXML(Document doc, SiteProfile siteProfile, String absoluteFileURL, HttpServletRequest req, FlowAdminModule flowAdminModule) {
		...
		if (flowAdminModule != null) {
			FlowFormElementableListener flowFormElementableListener = new FlowFormElementableListener(flowAdminModule);
	...
	public void populate(XMLParser xmlParser) throws ValidationException {
		...
		hideAsteriskInfo = xmlParser.getPrimitiveBoolean("hideAsteriskInfo");
	...
	public boolean isAllowDeletingInternalMessages() {

		return allowDeletingInternalMessages;
	}

	public void setAllowDeletingInternalMessages(boolean allowDeletingInternalMessages) {

		this.allowDeletingInternalMessages = allowDeletingInternalMessages;
	}
	...
	public boolean isHideAsteriskInfo() {

		return hideAsteriskInfo;
	}

	public void setHideAsteriskInfo(boolean hideAsteriskInfo) {

		this.hideAsteriskInfo = hideAsteriskInfo;
	}
	...
	public boolean isHideOverviewPDF() {

		return hideOverviewPDF;
	}

	public void setHideOverviewPDF(boolean hideOverviewPDF) {

		this.hideOverviewPDF = hideOverviewPDF;
	}

	public boolean isHideOverviewFlowInstance() {

		return hideOverviewFlowInstance;
	}

	public void setHideOverviewFlowInstance(boolean hideOverviewFlowInstance) {

		this.hideOverviewFlowInstance = hideOverviewFlowInstance;
	}
