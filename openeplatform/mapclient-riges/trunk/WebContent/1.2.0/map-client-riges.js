...
(function () {
	...
	if (!$("html").hasClass("map-client-riges")) {
		...
		var cssFiles = new Array(
			mapClientScriptLocation + "ext/resources/css/ext-all-oep.css",
			mapClientScriptLocation + "resources/OpenEMap.css",
			mapClientScriptLocation + "../css/map-client-riges.css",
			mapClientScriptLocation + "openlayers/theme/default/style.css"
		);
	
		var scripts = new Array(
			mapClientScriptLocation + "ext/ext-all.js",
			mapClientScriptLocation + "ext/ext-theme-oep.js",
			mapClientScriptLocation + "ext/locale/ext-lang-sv_SE.js",
			mapClientScriptLocation + "openlayers/OpenLayers.js",
			mapClientScriptLocation + "geoext2-all.js",
			mapClientScriptLocation + "es5-shim.min.js",	
			mapClientScriptLocation + "OpenEMap-all-debug.js"
	    );
...
function MapClientInstance(queryID, mapID){
	...
	this.mapImageLocation = mapClientScriptLocation + "resources/images/";
	this.config;
	this.originalTools;
	this.layerMapping = {};
