...
@XmlRootElement(name = "FetchPersons", namespace = "http://tieto.com/bix/")
public class FetchPersons {

    @XmlElement(namespace = "http://tieto.com/bix/", nillable = true)
    protected Connection connection;
    @XmlElement(name = "FirstName", namespace = "http://tieto.com/bix/", nillable = true)
    protected String firstName;
    @XmlElement(name = "LastName", namespace = "http://tieto.com/bix/", nillable = true)
    protected String lastName;
    @XmlElement(name = "Address", namespace = "http://tieto.com/bix/", nillable = true)
    protected String address;
    @XmlElement(name = "ZipCode", namespace = "http://tieto.com/bix/", nillable = true)
    protected String zipCode;
    @XmlElement(name = "City", namespace = "http://tieto.com/bix/", nillable = true)
    protected String city;
    @XmlElement(name = "BirthPlace", namespace = "http://tieto.com/bix/", nillable = true)
    protected String birthPlace;
    @XmlElement(name = "CivilStatus", namespace = "http://tieto.com/bix/", nillable = true)
