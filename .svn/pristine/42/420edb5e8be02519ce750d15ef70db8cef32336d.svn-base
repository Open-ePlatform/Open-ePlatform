...
@XMLElement
public class PUDAlternative extends GeneratedElementable implements ImmutableAlternative, Serializable {
	...
	public PUDAlternative(String name, Integer alternativeID, Integer sortIndex) {
