...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="ShowTextFieldQueryEndpoint">
		...
		<div class="floatleft full bigmarginbottom">
			<label><xsl:value-of select="$i18n.ResetQueryOnException"/></label><br/>
			<xsl:value-of select="Endpoint/resetQueryOnAPIException"/>
		</div>
			...
			<div class="floatleft full bigmarginbottom">
				...
				<div class="floatleft full">
					<xsl:call-template name="createCheckbox">
						<xsl:with-param name="id" select="'resetQueryOnAPIException'" />
						<xsl:with-param name="name" select="'resetQueryOnAPIException'" />
						<xsl:with-param name="value" select="'true'" />
						<xsl:with-param name="element" select="Endpoint" />
					</xsl:call-template>
					
					<label for="resetQueryOnAPIException">
						<xsl:value-of select="$i18n.ResetQueryOnException" />
					</label>
				</div>
					...
					<div class="floatleft full">
						...
						<div class="floatleft full">
							<xsl:call-template name="createDropdown">
								...
								<xsl:with-param name="selectedValue" select="Endpoint/apiSourceAccountID" />
							</xsl:call-template>
						</div>
					</div>
				</xsl:when>
