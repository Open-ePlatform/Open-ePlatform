...
import com.nordicpeak.flowengine.interfaces.LockableQuery;
...
@XMLElement
public class ChildQuery extends BaseQuery implements FixedAlternativesQuery, MultiSignQuery, CitizenIdentifierQuery, LockableQuery {
	...
	@DAOManaged
	@WebPopulate(paramName = "calculateMode", required = true)
	@XMLElement(name = "calculateMode")
	private ChildAgeCalculationMode calculationMode;
	...
	public void populate(XMLParser xmlParser) throws ValidationException {
		...
		calculationMode = EnumUtils.toEnum(ChildAgeCalculationMode.class, xmlParser.getString("calculationMode"));
