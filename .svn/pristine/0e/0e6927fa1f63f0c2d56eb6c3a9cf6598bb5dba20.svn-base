...
public class ContactDetailQuery extends BaseQuery implements CitizenIdentifierQuery {
	...
	@WebPopulate
	@XMLElement
	private boolean requireMobilePhoneOrPhone;
	
	@DAOManaged
	@WebPopulate
	@XMLElement
	private boolean requireContactDetailInfoVerification;
	...
	public void populate(XMLParser xmlParser) throws ValidationException {
		...
		forceSMS = xmlParser.getPrimitiveBoolean("forceSMS");
		requireMobilePhoneOrPhone = xmlParser.getPrimitiveBoolean("requireMobilePhoneOrPhone");
		requireContactDetailInfoVerification = xmlParser.getPrimitiveBoolean("requireContactDetailInfoVerification");
	...
	public boolean isRequireMobilePhoneOrPhone() {

		return requireMobilePhoneOrPhone;
	}

	public void setRequireMobilePhoneOrPhone(boolean requireMobilePhoneOrPhone) {
		
		this.requireMobilePhoneOrPhone = requireMobilePhoneOrPhone;
	}
	
	public boolean isRequireContactDetailInfoVerification() {

		return requireContactDetailInfoVerification;
	}

	public void setRequireContactDetailInfoVerification(boolean requireContactDetailInfoVerification) {
		
		this.requireContactDetailInfoVerification = requireContactDetailInfoVerification;
	}
