...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template name="activityForm">
		...
		<div class="d-flex full">
			<p id="onlyUseGlobalNotificationsInfo">
				<xsl:if test="Activity/onlyUseGlobalNotifications = 'false'">
					<xsl:attribute name="class">hidden</xsl:attribute>
				</xsl:if>
				
				<xsl:text>*</xsl:text>
				<xsl:value-of select="$i18n.Activity.onlyUseGlobalNotifiationsInfo"/>
			</p>
		</div>
		...
		<div class="floatleft margintop full">
			...
			<table class="full border">
				...
				<tr>
					...
					<td>
						<xsl:value-of select="$i18n.Tag.Attributes"/>
					</td>
				</tr>
