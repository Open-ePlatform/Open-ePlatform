...
@XMLElement
public class DropDownQueryInstance extends BaseQueryInstance implements FixedAlternativesQueryInstance, StringValueQueryInstance, PaymentQueryInstance, SearchableQueryInstance, LockableQueryInstance {
	...
	public List<String> getSearchableValues() {
		...
		if(!StringUtils.isEmpty(getStringValue()) && query.isSearchable()) {
