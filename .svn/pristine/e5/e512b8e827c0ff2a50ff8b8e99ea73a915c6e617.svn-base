...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="scripts">
		/js/manualmultisignqueryadmin.js
	</xsl:variable>	
	...
	<xsl:template match="UpdateManualMultiSignQuery">
		...
		<form id="updateManualMultiSignQueryForm" name="queryAdminForm" method="post" action="{/Document/requestinfo/uri}">
			...
			<div class="checkbox-setting">
				...
				<label for="hideCitizenIdetifierInPDF" class="nomargin">
			...
			<div class="checkbox-setting">
				...
				<label for="setMultipartsAsOwners" class="nomargin">
			...
			<div class="checkbox-setting">
				...
				<label for="preventPostersCitizenIdentifier" class="nomargin">
			...
			<div id="attribute-container" class="bigmarginbottom">
