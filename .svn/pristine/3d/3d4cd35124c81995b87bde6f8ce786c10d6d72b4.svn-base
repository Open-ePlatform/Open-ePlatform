...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:variable name="java.previewTitle">Förhandsgranska</xsl:variable>
	<xsl:variable name="java.signAndSubmitTitle">Signera och skicka in</xsl:variable>
	<xsl:variable name="java.payHeaderTitle">Betala</xsl:variable>
	<xsl:variable name="java.receiptTitle">Kvittens</xsl:variable>
	...
	<xsl:variable name="i18n.GoToPreviousStep">Gå till föregående steg, </xsl:variable>
	<xsl:variable name="i18n.GoToNextStep">Gå till nästa steg, </xsl:variable>
	<xsl:variable name="i18n.ListOfSteps">Lista över steg</xsl:variable>	
	...
	<xsl:variable name="i18n.DownloadFlowForms">Visa blanketter</xsl:variable>
	<xsl:variable name="i18n.DownloadFlowFormDescription.Part1">Hämta blankett</xsl:variable>
	<xsl:variable name="i18n.DownloadFlowFormDescription.Part2">i</xsl:variable>
	<xsl:variable name="i18n.DownloadFlowFormDescription.Part3">format</xsl:variable>
	<xsl:variable name="i18n.DownloadFlowFormsDescription">Visa blanketter för</xsl:variable>
	...
	<xsl:variable name="i18n.ManagerMessageSentEvent">Meddelande skickat till sökande</xsl:variable>
	<xsl:variable name="i18n.CustomersReadMessageEvent">Meddelande läst</xsl:variable>
	...
	<xsl:variable name="i18n.AsteriskInfo">Frågor eller fält markerade med asterisk (*) är obligatoriska</xsl:variable>
