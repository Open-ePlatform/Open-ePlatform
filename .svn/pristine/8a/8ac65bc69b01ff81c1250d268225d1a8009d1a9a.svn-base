...
public class OrganizationDetailQuery extends BaseQuery {
	...
	@WebPopulate
	@XMLElement
	private boolean requireContactInfoVerification;
	...
	public void populate(XMLParser xmlParser) throws ValidationException {
		...
		if (fieldEmail == OrganizationDetailQueryField.HIDDEN && fieldMobilePhone == OrganizationDetailQueryField.HIDDEN) {
			hideNotificationChannelSettings = true;
		} else {
		...
		requireContactInfoVerification = xmlParser.getPrimitiveBoolean("requireContactInfoVerification");
	...
	public boolean isRequireContactInfoVerification() {

		return requireContactInfoVerification;
	}

	public void setRequireContactInfoVerification(boolean requireContactInfoVerification) {
		
		this.requireContactInfoVerification = requireContactInfoVerification;
	}
