...
import com.nordicpeak.flowengine.queries.multitreequery.enums.PreviewMode;

@Table(name = "multi_tree_queries")
@XMLElement
public class MultiTreeQuery extends BaseQuery implements FixedAlternativesQuery {
	...
	@WebPopulate
	@XMLElement
	private PreviewMode previewMode = PreviewMode.TREE;

	@DAOManaged
	@OneToMany
	@XMLElement
	private List<MultiTreeQueryInstance> instances;
	...
	public List<MultiTreeQueryInstance> getInstances() {

		return instances;
	}

	public void setInstances(List<MultiTreeQueryInstance> instances) {
