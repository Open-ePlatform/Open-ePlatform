...
function extension($, window, document, undefined) {
...
$.ui.fancytree.registerExtension({
	...
	function waitUntilFancyTreeIsLoaded() {
		
		if(!(typeof $.ui.fancytree === "undefined")) {
			
			extension(jQuery, window, document);
			
		} else {
			setTimeout(function() { waitUntilFancyTreeIsLoaded(); }, 5);
		} 
	};
	
	waitUntilFancyTreeIsLoaded();
