...
public class Status extends GeneratedElementable implements Serializable, ImmutableStatus, XMLParserPopulateable, AccessInterface {
	...
	public static final List<Field> INTERNAL_FIELDS = ReflectionUtils.getFields(Status.class, "isUserMutable", "isUserDeletable", "isAdminMutable", "isAdminDeletable", "sortIndex");
