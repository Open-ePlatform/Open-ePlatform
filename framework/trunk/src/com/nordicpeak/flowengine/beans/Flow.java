...
public class Flow extends GeneratedElementable implements ImmutableFlow, XMLParserPopulateable, Named {
	...
	public static final Field HAS_PDF_FIELD = ReflectionUtils.getField(Flow.class,"hasPDF");
	...
	public void populate(XMLParser xmlParser) throws ValidationException {
		...
		this.hasPDF = xmlParser.getPrimitiveBoolean("hasPDF");
		this.externalPDF = XMLValidationUtils.validateParameter("externalPDF", xmlParser, false, 1, 255, StringHTTPURLPopulator.getPopulator(), errors);
	...
	public String getExternalPDF() {

		return externalPDF;
	}

	public void setExternalPDF(String externalPDF) {

		this.externalPDF = externalPDF;
	}
