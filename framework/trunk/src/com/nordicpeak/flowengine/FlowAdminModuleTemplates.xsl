			...
			<td>
				<xsl:choose>
					...
					<xsl:otherwise>
						...
						<a href="{/Document/requestinfo/currentURI}/{/Document/module/alias}/deleteflowfamily/{FlowFamily/flowFamilyID}" onclick="return confirmPost(this)" title="{$i18n.deleteFlowFamily.title}: {name}">
				...
				<div class="floatright adminicons">
					...
					<xsl:choose>
						<xsl:when test="$disableStructureManipulation = false()">
							...
							<a class="marginleft" href="{/Document/requestinfo/currentURI}/{/Document/module/alias}/deleteflow/{Flow/flowID}" onclick="return confirmPost(this)" title="{$i18n.deleteFlow.title}: {Flow/name}">
									...
									<tr>
										...
										<th width="37" >
											<xsl:if test="PublishAccess">
												<a href="{/Document/requestinfo/currentURI}/{/Document/module/alias}/unpublishflowfamily/{Flow/FlowFamily/flowFamilyID}/{Flow/flowID}" onclick="return confirmPost(this)" title="{$i18n.UnpublishFlowFamily}">
	...
	<xsl:template match="FlowForm" mode="list">
		...
		<div class="full">
			...
			<div class="floatright marginright">
				...
				<a href="{/Document/requestinfo/currentURI}/{/Document/module/alias}/deleteflowform/{flowFormID}" title="{$i18n.deleteFlowForm.link.title}: {$name}" onclick="return confirmPost(this)" >
	...
	<xsl:template match="ExternalMessageTemplate" mode="list">
		...
		<tr>
			...
			<td>
				...
				<a class="marginleft" href="{/Document/requestinfo/currentURI}/{/Document/module/alias}/deleteexternalmessagetemplate/{../../../flowID}/{templateID}" onclick="return confirmPost(this)" title="{$i18n.ExternalMessageTemplates.delete}: {name}">
					<img src="{$imgPath}/delete.png" alt="" />
				</a>
			</td>
		</tr>
		...
		<tr data-rel="versions">
			...
			<td>
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						<a class="marginleft" href="{/Document/requestinfo/currentURI}/{/Document/module/alias}/deleteflow/{flowID}" onclick="return confirmPost(this)" title="{$i18n.deleteFlow.title}: {name}">
							<img src="{$imgPath}/delete.png" alt="" />
						</a>
			...
			<div class="title">
				...
				<span class="tools">
					<xsl:if test="$disableStructureManipulation = false()">
						...
						<a class="marginleft" href="{/Document/requestinfo/currentURI}/{/Document/module/alias}/deletestep/{stepID}" onclick="return confirmPost(this)" title="{$i18n.deleteStep.title}: {name}">
							<img src="{$imgPath}/delete.png" alt="" />
						</a>
					</xsl:if>
				</span>		
				...
				<span class="tools">
					<xsl:choose>
						<xsl:when test="$disableStructureManipulation = false()">
							...
							<a class="marginleft" href="{/Document/requestinfo/currentURI}/{/Document/module/alias}/deletequery/{queryID}" onclick="return confirmPost(this)" title="{$i18n.deleteQuery.title}: {name}">
								<img src="{$imgPath}/delete.png" alt="" />
							</a>
			...
			<div class="title">
				...
				<span class="tools">
					<xsl:if test="$disableStructureManipulation = false()">
						...
						<a class="marginleft" href="{/Document/requestinfo/currentURI}/{/Document/module/alias}/deleteevaluator/{evaluatorID}" onclick="return confirmPost(this)" title="{$i18n.deleteEvaluator.title}: {name}">
							<img src="{$imgPath}/delete.png" alt="" />
						</a>
					</xsl:if>
				</span>
			...
			<td>
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						...
						<a class="marginleft" href="{/Document/requestinfo/currentURI}/{/Document/module/alias}/deletestatus/{statusID}" onclick="return confirmPost(this);" title="{$i18n.deleteStatus.link.title}: {name}">
							<img src="{$imgPath}/delete.png" alt="" />
						</a>
		...
		<tr>
			...
			<td>
				...
				<xsl:if test="statusGroupID != 1">
					<a class="marginleft" href="{/Document/requestinfo/currentURI}/{/Document/module/alias}/deletestandardstatusgroup/{statusGroupID}" onclick="return confirmPost(this)" title="{$i18n.DeleteStandardStatusGroup}: {name}">
						<img src="{$imgPath}/delete.png" alt="" />
					</a>
				</xsl:if>
			</td>
	...
	<xsl:template match="StandardStatus" mode="list">
		...
		<tr>
			...
			<td>
				...
				<a class="marginleft" href="{/Document/requestinfo/currentURI}/{/Document/module/alias}/deletestandardstatus/{statusID}" onclick="return confirmPost(this)" title="{$i18n.DeleteStandardStatus}: {name}">
					<img src="{$imgPath}/delete.png" alt="" />
				</a>
			</td>
		</tr>
				...
				<xsl:if test="../../AdminAccess">
					...
					<xsl:choose>
						...
						<xsl:otherwise>
							...
							<a href="{/Document/requestinfo/currentURI}/{/Document/module/alias}/deleteflowtype/{flowTypeID}" onclick="return confirmPost(this)" title="{$i18n.deleteFlowType}: {name}">
			...
			<div class="floatright">
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						...
						<a href="{/Document/requestinfo/currentURI}/{/Document/module/alias}/deleteflowtype/{FlowType/flowTypeID}" onclick="return confirmPost(this)" title="{$i18n.deleteFlowType}: {FlowType/name}">
							<img class="alignbottom" src="{$imgPath}/delete.png" alt="" />
						</a>
	...
	<xsl:template match="Category" mode="list">
		...
		<div class="floatleft full marginbottom border">
			...
			<div class="floatright marginright">
				...
				<a href="{/Document/requestinfo/currentURI}/{/Document/module/alias}/deletecategory/{categoryID}" onclick="return confirmPost(this)" title="{$i18n.deleteCategory}: {name}">
					<img class="alignbottom" src="{$imgPath}/delete.png" alt="" />
				</a>
